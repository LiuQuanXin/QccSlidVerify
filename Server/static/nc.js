            ...
            !function (e) {
                ...
                function (e, t, n) {
                    ...
                    t.decorator = h, t.mix = function (e) {
                        ...
                        var t = p.defer(),
                            n = e.data || {}, i = ("jsonp_" + Math.random()).replace(".", "");
                        d[i] = function (e) {
                            t.resolve(e)
                ...
                function (e, t, n) {
                    ...
                    p = '//127.0.0.1:8880/static/awsc.js';
                    // p = '//g.alicdn.com/AWSC/AWSC/awsc.js';
                    var _ = {
                        0: {
                        ...
                        return NoCaptcha.prototype = {
                            ...
                            initializationReport: function () {
                                var e = ("initializeJsonp_" + Math.random()).replace(".", ""),
                                    t = ajaxURL.initialize + "?a=" + encodeURIComponent(opt.appkey) + "&t=" + encodeURIComponent(opt.token) + "&scene=" + encodeURIComponent(opt.scene) + "&lang=" + opt.language + "&v=v1.2.17&href=" + encodeURIComponent("https://www.qichacha.com/user_login") + "&comm={}&callback=" + e,
                            ...
                            onScaleReady: function onScaleReady(elem) {
                                function waitForUmx() {
                                    if (is_umx_getStatus_timeout || umx.getStatus()) {
                                        ...
                                        _.jsonp({
                                            // url: '//127.0.0.1:8880/ali',
                                            url: '//cf.aliyun.com/nocaptcha/analyze.jsonp',
                                            callback: "callback",
                                            data: {
                                                a: opt.appkey,
                                                t: opt.token,
